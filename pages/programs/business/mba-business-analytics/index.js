...
import { attributes, html } from '../../../../content/pages/programs/business/mba-business-analytics/index.md'
...
const MBABusinessAnalytics = (testimonials) => {
  let programType = attributes.sections.find( ({ type }) => type === 'testimonials_section');
  let filterTestimonials = testimonials ? testimonials.testimonials.filter((obj) => obj.attributes.program === programType.program).splice(0, programType.limit): null;
  return (
  <Layout>

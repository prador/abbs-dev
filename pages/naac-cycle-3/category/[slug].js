...
const Docs = ({ docList }) => {
  ...
  <div className="content animate__animated animate__fadeInUp">
      ...
      {docList? <NaacDocumentsSection docs={docList.filter((obj) => !obj.attributes.category.localeCompare(slug, undefined, { sensitivity: 'accent' }))} /> : ""}
...
export async function getStaticPaths() {
    const paths = fs
      .readdirSync(path.join(process.cwd(), 'content/naac_docs'))
      .map((docName) => {
